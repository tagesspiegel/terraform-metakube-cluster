...
| <a name="input_openstack_network_config"></a> [openstack\_network\_config](#input\_openstack\_network\_config) | n/a | <pre>object({<br>    network_id   = optional(string)<br>    subnet_id    = optional(string)<br>    cidr = optional(string)<br>  })</pre> | n/a | yes |
